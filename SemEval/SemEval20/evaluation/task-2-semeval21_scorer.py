...
import src.annotations_from_json as ans
...
def main(args):
    ...
    user_annotations = ans.AnnotationsFromJson()
    ...
    gold_annotations = ans.AnnotationsFromJson()
    ...
    if not user_annotations.compare_annotations_identical_article_lists(gold_annotations): 
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Scorer for SemEval 2021 Task 6 subtask 2.\n" +
    "Example: python3 task-2-semeval21_scorer.py -s data/submission-task-TC.tsv -r data/article736757214.task-FLC.labels -p data/propaganda-techniques-names-semeval2020task11.txt")
